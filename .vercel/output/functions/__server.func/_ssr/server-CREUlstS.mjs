...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-CREUlstS.js
var server_CREUlstS_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dss9EoPK.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BB8Kf0Qp.mjs").then((n) => n.t),
		import("./start-DtpAnyoL.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_CREUlstS_exports as t };
